...
import { EmployeeTaskTableComponent } from './shared/employee-task-table/employee-task-table.component';
...
const routes: Routes = [
  ...
  {path:"Employee-view-table",component:EmployeeTaskTableComponent,data:{showExport:true,hideFooterButtons:true}},
