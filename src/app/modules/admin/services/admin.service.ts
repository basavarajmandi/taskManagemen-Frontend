...
export class AdminService {
  ...
  getUsers(): Observable<any> {
    return this.httpClient.get(this.BASE_URL + "api/admin/users", {
      headers: this.createAuthorizationHeader()
    })
  }

  getAllTask(): Observable<TaskDTO[]> {
    return this.httpClient.get<TaskDTO[]>(this.BASE_URL + "api/admin/tasks", {
      headers: this.createAuthorizationHeader()
    })
  }
  ...
  getTaskById(id: number): Observable<any> {
    return this.httpClient.get(this.BASE_URL + `api/admin/task/${id}`, {
      headers: this.createAuthorizationHeader(),
    }).pipe(
      map((task: any) => {

        if (task.imageName && !task.imageName.startsWith('http')) {
          task.imageName = `${this.BASE_URL}api/files/images/${task.imageName}`;
        }
        if (task.voiceName && !task.voiceName.startsWith('http')) {
          task.voiceName = `${this.BASE_URL}api/files/voice/${task.voiceName}`;
        }
        return task;
      })
    );
  ...
  postTask(taskData: any, file?: File, voiceFile?: File): Observable<any> {
    ...
    return this.httpClient.post(this.BASE_URL + "api/admin/savetask", formData, {
  ...
  updateTask(id: number, taskDto: any, image?: File, voice?: File): Observable<any> {
    ...
    return this.httpClient.put(this.BASE_URL + `api/admin/task/${id}`, formData, {
      headers: this.createAuthorizationHeaderWithoutJSON(), // No 'Content-Type' for FormData
    });
  }
  getCategories(): Observable<any> {
    return this.httpClient.get(this.BASE_URL + "api/admin/categories", {
      headers: this.createAuthorizationHeader(),
    });
  }

  getTasksDueToday(): Observable<TaskDTO[]> {
    return this.httpClient.get<TaskDTO[]>(this.BASE_URL + "api/admin/tasks/today", {
      headers: this.createAuthorizationHeader(),
    });
  }

  getTasksDueYesterday(): Observable<TaskDTO[]> {
    return this.httpClient.get<TaskDTO[]>(this.BASE_URL + "api/admin/tasks/yesterday", {
      headers: this.createAuthorizationHeader(),
    });
  }

  getTasksThisWeek(): Observable<TaskDTO[]> {
    return this.httpClient.get<TaskDTO[]>(this.BASE_URL + "api/admin/tasks/this-week", {
      headers: this.createAuthorizationHeader(),
    });
  }

  getTasksLastWeek(): Observable<TaskDTO[]> {
    return this.httpClient.get<TaskDTO[]>(this.BASE_URL + "api/admin/tasks/last-week", {
      headers: this.createAuthorizationHeader(),
    });
  }

  getTasksThisMonth(): Observable<TaskDTO[]> {
    return this.httpClient.get<TaskDTO[]>(this.BASE_URL + "api/admin/tasks/this-month", {
      headers: this.createAuthorizationHeader(),
    });
  }

  getTasksLastMonth(): Observable<TaskDTO[]> {
    return this.httpClient.get<TaskDTO[]>(this.BASE_URL + "api/admin/tasks/last-month", {
      headers: this.createAuthorizationHeader(),
    });
  }

  getTasksThisYear(): Observable<TaskDTO[]> {
    return this.httpClient.get<TaskDTO[]>(this.BASE_URL + "api/admin/tasks/this-year", {
      headers: this.createAuthorizationHeader(),
    });
  }
  ...
  getTasksByCustomRange(startDate: Date, endDate: Date): Observable<TaskDTO[]> {
    ...
    return this.httpClient.get<TaskDTO[]>(this.BASE_URL + "api/admin/tasks/custom", {
      headers: this.createAuthorizationHeader(),
      params: params
    });
  }
  ...
  getAllTaskWithPagination(params: any): Observable<PaginatedResponse> {
    ...
    return this.httpClient.get<PaginatedResponse>(this.BASE_URL + 'api/admin/tasks/paginated', {
      params: httpParams,
      headers: this.createAuthorizationHeader(),
    }
    );
  ...
  deleteTask(id: number): Observable<any> {
    return this.httpClient.delete(this.BASE_URL + `api/admin/task/${id}`, {
      headers: this.createAuthorizationHeader()
    })
  }

  searchTask(title: string): Observable<any> {
    return this.httpClient.get(this.BASE_URL + `api/admin/task/search/${title}`, {
      headers: this.createAuthorizationHeader()
    })
  }

  searchTaskByPriority(priority: string): Observable<any> {
    return this.httpClient.get(this.BASE_URL + `api/admin/task/search/${priority}`, {
      headers: this.createAuthorizationHeader()
    });
  }
  createComment(id: number, content: string): Observable<any> {
    ...
    return this.httpClient.post(this.BASE_URL + `api/admin/task/comment`, content, {
      params: params,
      headers: this.createAuthorizationHeader()
    });
  }
  ...
  getCommentsByTaskId(id: number): Observable<any> {
    return this.httpClient.get(this.BASE_URL + `api/admin/task/${id}/comments`, {
      headers: this.createAuthorizationHeader()
    }
    )
  }
  ...
  getAllCategories(): Observable<string[]> {
    return this.httpClient.get<string[]>(this.BASE_URL + 'api/admin/filter/categories', {
      headers: this.createAuthorizationHeader(),
    });
  }

  getOverdueTaskCount(): Observable<number> {
    return this.httpClient.get<number>(this.BASE_URL + 'api/admin/tasks/overdue', {
      headers: this.createAuthorizationHeader()
    });
  }
  ...
  getTaskStatusCounts(): Observable<Record<string, number>> {
    ...
    return this.httpClient.get<Record<string, number>>(this.BASE_URL + 'api/admin/tasks/status-counts', {
      headers: this.createAuthorizationHeader(),
    });
  }

  getTaskCountByStatus(status: string): Observable<number> {
    return this.httpClient.get<number>(`${this.BASE_URL}/api/admin/tasks/{status}`);
  }

  getAllOverdueTask(): Observable<TaskDTO[]> {
    return this.httpClient.get<TaskDTO[]>(this.BASE_URL + 'api/admin/task/alloverdue', {
      headers: this.createAuthorizationHeader()
    })
  }

  getTaskCountsByPriotity(): Observable<any> {
    return this.httpClient.get(this.BASE_URL + 'api/admin/tasks/priority-counts', {
      headers: this.createAuthorizationHeader(),
    });
  }

  exportToExcel(): Observable<Blob> {
    return this.httpClient.get(this.BASE_URL + 'api/admin/tasks/export', {
      headers: this.createAuthorizationHeader(),
